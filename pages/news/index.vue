      ...
      <PageSection>
        <main>
          ...
          <div class="flex flex-wrap">
            ...
            <div v-for="article in list" :key="article._path" class="w-full md:w-1/2 px-2 xs:mb-6 md:mb-12">
        <NuxtLink :to="article._path">
          ...
          >
            ...
            <div class="p-6 border-l-4 border-blue-400">
              <div>
                <div class="flex">
                  <h3 class="mt-2 text-2xl font-semibold text-primary-400 dark:text-white hover:underline">
                    {{ article.title }}
                  </h3>
